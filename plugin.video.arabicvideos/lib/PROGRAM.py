...
def GLOBAL_SEARCH():
	search = KEYBOARD()
	if search == '': return
	addDir('[COLOR FFC89008]HLA [/COLOR]'+'موقع هلا سيما'+'   .13','',89,'','','',search)
	addDir('[COLOR FFC89008]SHA [/COLOR]'+'موقع شاهد فوريو'+'   .12','',119,'','','',search)
	addDir('[COLOR FFC89008]HEL [/COLOR]'+'موقع هلال يوتيوب'+'   .11','',99,'','','',search)
	addDir('[COLOR FFC89008]AKM [/COLOR]'+'موقع اكوام'+'   .10','',79,'','','',search)
	addDir('[COLOR FFC89008]FTM [/COLOR]'+'موقع المنبر الفاطمي'+'   .8','',69,'','','',search)
	addDir('[COLOR FFC89008]MRF [/COLOR]'+'موقع قناة المعارف'+'   .7','',49,'','','',search)
	addDir('[COLOR FFC89008]KWT [/COLOR]'+'موقع قناة الكوثر'+'   .6','',139,'','','',search)
	addDir('[COLOR FFC89008]IFL   [/COLOR]'+'موقع قناة اي فيلم'+'   .5','',29,'','','',search)
	addDir('[COLOR FFC89008]PNT [/COLOR]'+'موقع بانيت'+'   .4','',39,'','','',search)
	addDir('[COLOR FFC89008]KLA  [/COLOR]'+'موقع كل العرب'+'   .3','',19,'','','',search)
	addDir('[COLOR FFC89008]EGB [/COLOR]'+'موقع ايجي بيست'+'   .2','',129,'','','',search)
	addDir('[COLOR FFC89008]SHF [/COLOR]'+'موقع شوف ماكس'+'   .1','',59,'','','',search)
