...
def GLOBAL_SEARCH():
	...
	addDir('[COLOR FFC89008]AKM [/COLOR]'+'موقع اكوام'+'   .9','',79,'','','',search)
	addDir('[COLOR FFC89008]HEL [/COLOR]'+'موقع هلال يوتيوب'+'   .10','',99,'','','',search)
	addDir('[COLOR FFC89008]SHA [/COLOR]'+'موقع شاهد فوريو'+'   .11','',119,'','','',search)
	addDir('[COLOR FFC89008]HLA [/COLOR]'+'موقع هلا سيما'+'   .12','',89,'','','',search)
