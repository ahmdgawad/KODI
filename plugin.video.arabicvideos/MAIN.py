...
def MAIN():
	#addLink('Testing','',9)
	addDir('ـMessage to developer    رسالة الى المبرمج'+'   .15','',2)
	addDir('ـ DMCA     قانون الألفية للملكية الرقمية'+'   .14','',3)
	addDir('ـProblems & Solutions    مشاكل وحلول'+'   .13','',1000)
	addDir('قنوات تلفزونية'+'   .12','',100)
	#addDir('=========================','',9999)
	addDir('موقع قناة اي فيلم'+'   .11','',20)
	addDir('موقع قناة المعارف'+'   .10','',40)
	addDir('موقع المنبر الفاطمي'+'   .9','',60)
	addDir('موقع هلال يوتيوب'+'   .8','',90)
	addDir('موقع شوف ماكس'+'   .7','',50)
	addDir('موقع بانيت'+'   .6','',30)
	addDir('موقع شاهد فوريو'+'   .5','',110)
	addDir('موقع هلا سيما'+'   .4','',80)
	addDir('موقع كل العرب'+'   .3','',10)
	addDir('موقع اكوام'+'   .2','',70)
	addDir('موقع ايجي بيست'+'   .1','',120)
