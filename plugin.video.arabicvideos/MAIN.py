...
def MAIN():
	...
	addDir('[COLOR FFC89008]HEL [/COLOR]'+'موقع هلال يوتيوب (مشفر)'+'   .13','',90)
	addDir('[COLOR FFC89008]HLA [/COLOR]'+'موقع هلا سيما (مشفر)'+'   .12','',80)
	addDir('[COLOR FFC89008]SHA [/COLOR]'+'موقع شاهد فوريو'+'   .11','',110)
	...
	addDir('[COLOR FFC89008]AKM [/COLOR]'+'موقع اكوام (مشفر)'+'   .3','',70)
